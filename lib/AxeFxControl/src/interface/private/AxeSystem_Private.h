...
// A full 50-effect dump needs 6 header + 150 data + 2 footer bytes.
const static byte MAX_SYSEX = 192;
...
bool _presetDetailsReported = false;
AxeLooper _looper;
...
byte _sysexCount = 0;
byte _midiStatus = 0, _midiDataCount = 0, _midiData[2] = {};
